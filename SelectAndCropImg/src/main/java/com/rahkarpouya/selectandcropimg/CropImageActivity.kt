...
open class CropImageActivity : AppCompatActivity(), CropImageView.OnSetImageUriCompleteListener,
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (actionBar != null) {
            val title =
                if (mOptions != null && mOptions!!.activityTitle != null && mOptions!!.activityTitle!!.isNotEmpty()
    ...
    override fun onActivityResult(
        ...
        if (requestCode == CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_CANCELED) { // User cancelled the picker. We don't have anything to crop
                setResultCancel()
            }
    ...
    private fun updateMenuItemIconColor(
        ...
        if (menuItem != null) {
            ...
            if (menuItemIcon != null) {
                try {
                    menuItemIcon.mutate()
                    menuItemIcon.colorFilter = PorterDuffColorFilter(color,PorterDuff.Mode.SRC_ATOP)
