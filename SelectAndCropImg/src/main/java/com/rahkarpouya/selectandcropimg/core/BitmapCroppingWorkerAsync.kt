...
import com.rahkarpouya.selectandcropimg.utils.BitmapUtils.BitmapSampled
import com.rahkarpouya.selectandcropimg.CropImageView
import com.rahkarpouya.selectandcropimg.ImageCroppingResult
...
class BitmapCroppingWorkerAsync : BaseCoroutine {
            ...
            val result = withContext(Dispatchers.Default) {
                try {
                    val bitmapSampled: BitmapSampled = when {
                        ...
                        else -> BitmapSampled(null as Bitmap?, 1)
                    }
