...
internal class CropWindowHandler {
    ...
    val minCropWidth: Float
        get() = mMinCropWindowWidth.coerceAtLeast(mMinCropResultWidth / scaleFactorWidth)

    /** Minimum height in pixels that the crop window can get.  */
    val minCropHeight: Float
        get() = mMinCropWindowHeight.coerceAtLeast(mMinCropResultHeight / scaleFactorHeight)

    /** Maximum width in pixels that the crop window can get.  */
    val maxCropWidth: Float
        get() = mMaxCropWindowWidth.coerceAtMost(mMaxCropResultWidth / scaleFactorWidth)

    /** Maximum height in pixels that the crop window can get.  */
    val maxCropHeight: Float
        get() = mMaxCropWindowHeight.coerceAtMost(mMaxCropResultHeight / scaleFactorHeight)
    ...
    fun getMoveHandler(
        ...
        val type =
            if (cropShape == CropShape.OVAL) getOvalPressedMoveType(
                x,
                y
